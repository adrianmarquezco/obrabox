      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">
                Obra<span className="text-primary-400">Box</span>
              </span>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              El software de gestión para empresas de reformas y construcción en
              España. Obras, presupuestos, clientes y equipo en una sola app.
            </p>
            <div className="inline-flex items-center gap-1.5 bg-white/10 rounded-full px-3 py-1 text-xs">
              <span>🇪🇸</span>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} ObraBox. Todos los derechos
            reservados.
          </p>
          <div className="flex items-center gap-4">
            <a
              href="https://www.instagram.com/obrabox.es"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/company/obrabox"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-primary-400 transition-colors"
              aria-label="LinkedIn"
            ...
            <a
              href="https://www.youtube.com/@obrabox"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-primary-400 transition-colors"
              aria-label="YouTube"
